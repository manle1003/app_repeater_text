...
class Code128Screen extends StatelessWidget {
    ...
    return Obx(
      () => Scaffold(
        appBar: AppBar(
          ...
          actions: [
            Obx(
              () => scanQrCodeController.isCheckCode128.value
                  ? MenuPopupCustom(
                      onPressedDelete: () {
                        scanQrCodeController.code128Controller.clear();
                        scanQrCodeController.isCheckCode128.value = false;
                      },
                      onPressedShare: () {},
                    )
                  : IconButton(
                      onPressed: () =>
                          scanQrCodeController.createBarcodeCode128(context),
            ...
            children: [
                                    ...
                                    pressOK: () {
                                      scanQrCodeController.changeTitle(
                                        ...
                                        scanQrCodeController
                                            .changeTitleCode128FormKey,
                                        scanQrCodeController
                                            .changeTitleCode128Controller.text,
                                      );
                                    },
                                    textEditingController: scanQrCodeController
                                        .changeTitleCode128Controller,
                                  ),
                                );
                                scanQrCodeController
                                    .changeTitleCode128Controller
              ...
              Obx(
                () => scanQrCodeController.isCheckCode128.value
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: Screenshot(
                                  ...
                                  child: BarcodeWidget(
                                    barcode:
                                        Barcode.fromType(BarcodeType.Code128),
                    ...
                    : Form(
                        key: scanQrCodeController.code128FormKey,
                        child: Padding(
                          ...
                          child: TextArea(
                            ...
                            textEditingController:
                                scanQrCodeController.code128Controller,
                            onSuffixIconPressed: () => {},
                            validation:
